namespace RelationModelsMVC.Models
{
    public class DataInitializer
    {
        ...
        public static List<Employ>SeedEmploy()
        {
            ...
            {
                new Employ {Id = 1, Name = "Rik", Position="Manager", Department = new Department{Name="IT"}},
                new Employ {Id = 2, Name = "Alain", Position="Manager", Department = new Department{Name="IT"}},
